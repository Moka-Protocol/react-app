...
function FRAX(props) {
  ...
  return (
    <svg height={size} width={size} x="0px" y="0px" viewBox="0 0 570.4 570.4">
      <g id="layer1" transform="translate(295.65791,-75.71863)">
        <circle id="path854" fillRule="evenodd" clipRule="evenodd" stroke="#000000" strokeWidth="1.2373" strokeMiterlimit="11.3386" cx="-10.5" cy="360.9" r="284.6"/>
        <path id="path862" fill="#FFFFFF" d="M-167.5,202.6c-12,12.6-21.9,23.2-22,23.4c-0.1,0.3,10.7,10.9,24,23.5
